...
TEMP_MKSQUSHFS_CPU_NUM=$(shell expr `grep -c process /proc/cpuinfo` / 2)
MKSQUSHFS_CPU_NUM=$(shell if [ ${TEMP_MKSQUSHFS_CPU_NUM} -lt 1 ];then echo 1;else echo ${TEMP_MKSQUSHFS_CPU_NUM};fi)
