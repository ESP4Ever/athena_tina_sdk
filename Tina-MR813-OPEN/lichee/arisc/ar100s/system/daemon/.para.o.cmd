cmd_system/daemon/para.o := or32-elf-gcc -Wp,-MD,system/daemon/.para.o.d -Wp,-MT,system/daemon/para.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Isystem/daemon/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(para)" -c -o system/daemon/para.o system/daemon/para.c

source_system/daemon/para.o := system/daemon/para.c

deps_system/daemon/para.o := \
...
system/daemon/para.o: $(deps_system/daemon/para.o)
