cmd_system/daemon/daemon.o := or32-elf-gcc -Wp,-MD,system/daemon/.daemon.o.d -Wp,-MT,system/daemon/daemon.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Isystem/daemon/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(daemon)" -c -o system/daemon/daemon.o system/daemon/daemon.c

source_system/daemon/daemon.o := system/daemon/daemon.c

deps_system/daemon/daemon.o := \
  include/generated/autoconf.h \
  include/generated/conf.h \
  system/daemon/daemon_i.h \
  include/include.h \
...
system/daemon/daemon.o: $(deps_system/daemon/daemon.o)
