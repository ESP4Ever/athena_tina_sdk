cmd_system/debugger/debugger.o := or32-elf-gcc -Wp,-MD,system/debugger/.debugger.o.d -Wp,-MT,system/debugger/debugger.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Isystem/debugger/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(debugger)" -c -o system/debugger/debugger.o system/debugger/debugger.c

source_system/debugger/debugger.o := system/debugger/debugger.c

deps_system/debugger/debugger.o := \
  include/generated/autoconf.h \
  include/generated/conf.h \
  system/debugger/debugger_i.h \
  include/include.h \
...
system/debugger/debugger.o: $(deps_system/debugger/debugger.o)
