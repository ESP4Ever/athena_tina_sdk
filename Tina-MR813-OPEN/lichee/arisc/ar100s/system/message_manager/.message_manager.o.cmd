cmd_system/message_manager/message_manager.o := or32-elf-gcc -Wp,-MD,system/message_manager/.message_manager.o.d -Wp,-MT,system/message_manager/message_manager.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Isystem/message_manager/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(message_manager)" -c -o system/message_manager/message_manager.o system/message_manager/message_manager.c

source_system/message_manager/message_manager.o := system/message_manager/message_manager.c

deps_system/message_manager/message_manager.o := \
...
system/message_manager/message_manager.o: $(deps_system/message_manager/message_manager.o)
