cmd_system/notifier/notifier.o := or32-elf-gcc -Wp,-MD,system/notifier/.notifier.o.d -Wp,-MT,system/notifier/notifier.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Isystem/notifier/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(notifier)" -c -o system/notifier/notifier.o system/notifier/notifier.c

source_system/notifier/notifier.o := system/notifier/notifier.c

deps_system/notifier/notifier.o := \
  include/generated/autoconf.h \
  include/generated/conf.h \
  system/notifier/notifier_i.h \
  include/include.h \
...
system/notifier/notifier.o: $(deps_system/notifier/notifier.o)
