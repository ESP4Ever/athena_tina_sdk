cmd_library/libfdt/fdt_strerror.o := or32-elf-gcc -Wp,-MD,library/libfdt/.fdt_strerror.o.d -Wp,-MT,library/libfdt/fdt_strerror.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Ilibrary/libfdt/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(fdt_strerror)" -c -o library/libfdt/fdt_strerror.o library/libfdt/fdt_strerror.c

source_library/libfdt/fdt_strerror.o := library/libfdt/fdt_strerror.c

deps_library/libfdt/fdt_strerror.o := \
...
library/libfdt/fdt_strerror.o: $(deps_library/libfdt/fdt_strerror.o)
