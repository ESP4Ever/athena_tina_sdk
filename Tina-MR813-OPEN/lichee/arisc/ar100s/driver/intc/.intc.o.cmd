cmd_driver/intc/intc.o := or32-elf-gcc -Wp,-MD,driver/intc/.intc.o.d -Wp,-MT,driver/intc/intc.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Idriver/intc/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(intc)" -c -o driver/intc/intc.o driver/intc/intc.c

source_driver/intc/intc.o := driver/intc/intc.c

deps_driver/intc/intc.o := \
...
driver/intc/intc.o: $(deps_driver/intc/intc.o)
