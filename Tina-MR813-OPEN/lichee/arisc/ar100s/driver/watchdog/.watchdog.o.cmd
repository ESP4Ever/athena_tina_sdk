cmd_driver/watchdog/watchdog.o := or32-elf-gcc -Wp,-MD,driver/watchdog/.watchdog.o.d -Wp,-MT,driver/watchdog/watchdog.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Idriver/watchdog/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(watchdog)" -c -o driver/watchdog/watchdog.o driver/watchdog/watchdog.c

source_driver/watchdog/watchdog.o := driver/watchdog/watchdog.c

deps_driver/watchdog/watchdog.o := \
  include/generated/autoconf.h \
  include/generated/conf.h \
  driver/watchdog/watchdog_i.h \
  include/include.h \
...
driver/watchdog/watchdog.o: $(deps_driver/watchdog/watchdog.o)
