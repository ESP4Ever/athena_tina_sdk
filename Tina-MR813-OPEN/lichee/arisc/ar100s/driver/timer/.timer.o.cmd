cmd_driver/timer/timer.o := or32-elf-gcc -Wp,-MD,driver/timer/.timer.o.d -Wp,-MT,driver/timer/timer.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Idriver/timer/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(timer)" -c -o driver/timer/timer.o driver/timer/timer.c

source_driver/timer/timer.o := driver/timer/timer.c

deps_driver/timer/timer.o := \
...
driver/timer/timer.o: $(deps_driver/timer/timer.o)
