cmd_driver/pin/pin.o := or32-elf-gcc -Wp,-MD,driver/pin/.pin.o.d -Wp,-MT,driver/pin/pin.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Idriver/pin/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(pin)" -c -o driver/pin/pin.o driver/pin/pin.c

source_driver/pin/pin.o := driver/pin/pin.c

deps_driver/pin/pin.o := \
...
driver/pin/pin.o: $(deps_driver/pin/pin.o)
