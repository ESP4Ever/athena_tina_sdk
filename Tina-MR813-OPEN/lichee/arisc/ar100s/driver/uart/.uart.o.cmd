cmd_driver/uart/uart.o := or32-elf-gcc -Wp,-MD,driver/uart/.uart.o.d -Wp,-MT,driver/uart/uart.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Idriver/uart/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(uart)" -c -o driver/uart/uart.o driver/uart/uart.c

source_driver/uart/uart.o := driver/uart/uart.c

deps_driver/uart/uart.o := \
  include/generated/autoconf.h \
  include/generated/conf.h \
  driver/uart/uart_i.h \
  include/include.h \
...
driver/uart/uart.o: $(deps_driver/uart/uart.o)
