cmd_driver/twi/twi.o := or32-elf-gcc -Wp,-MD,driver/twi/.twi.o.d -Wp,-MT,driver/twi/twi.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Idriver/twi/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(twi)" -c -o driver/twi/twi.o driver/twi/twi.c

source_driver/twi/twi.o := driver/twi/twi.c

deps_driver/twi/twi.o := \
...
driver/twi/twi.o: $(deps_driver/twi/twi.o)
