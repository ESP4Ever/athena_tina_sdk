cmd_service/standby/wakeup_source.o := or32-elf-gcc -Wp,-MD,service/standby/.wakeup_source.o.d -Wp,-MT,service/standby/wakeup_source.o -Iinclude -Iinclude/driver -Iinclude/service -Iinclude/system -Ilibrary/libfdt/include -Iarch/openrisc/plat-sun50iw10p1/inc -Iservice/standby/suspend_resume/mem-sun50iw10p1/ -Iinclude/generated -include include/generated/autoconf.h -include conf.h -g -c -nostdlib -Wall -Werror -Os -mhard-mul -msoft-div -msoft-float -Iservice/standby/ -D"BUILD_STR(s)=$(pound)s" -D"KBUILD_NAME=BUILD_STR(wakeup_source)" -c -o service/standby/wakeup_source.o service/standby/wakeup_source.c

source_service/standby/wakeup_source.o := service/standby/wakeup_source.c

deps_service/standby/wakeup_source.o := \
  ...
  arch/openrisc/plat-sun50iw10p1/inc/irq_table.h \

service/standby/wakeup_source.o: $(deps_service/standby/wakeup_source.o)
